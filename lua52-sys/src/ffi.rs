...
// Generated with: bindgen 0.59.2

pub const LUA_LDIR: &[u8; 7usize] = b"!\\lua\\\0";
pub const LUA_CDIR: &[u8; 3usize] = b"!\\\0";
pub const LUA_PATH_DEFAULT: &[u8; 58usize] =
    b"!\\lua\\?.lua;!\\lua\\?\\init.lua;!\\?.lua;!\\?\\init.lua;.\\?.lua\0";
pub const LUA_CPATH_DEFAULT: &[u8; 30usize] = b"!\\?.dll;!\\loadall.dll;.\\?.dll\0";
pub const LUA_DIRSEP: &[u8; 2usize] = b"\\\0";
pub const LUA_ENV: &[u8; 5usize] = b"_ENV\0";
...
pub const LUA_VERSION_MINOR: &[u8; 2usize] = b"2\0";
pub const LUA_VERSION_NUM: i32 = 502;
pub const LUA_VERSION_RELEASE: &[u8; 2usize] = b"4\0";
pub const LUA_VERSION: &[u8; 8usize] = b"Lua 5.2\0";
pub const LUA_RELEASE: &[u8; 10usize] = b"Lua 5.2.4\0";
pub const LUA_COPYRIGHT: &[u8; 52usize] = b"Lua 5.2.4  Copyright (C) 1994-2015 Lua.org, PUC-Rio\0";
...
/// <https://www.lua.org/manual/5.2/manual.html#lua_State>
pub struct lua_State {
    _unused: [u8; 0],
}
/// <https://www.lua.org/manual/5.2/manual.html#lua_CFunction>
pub type lua_CFunction =
    ::core::option::Option<unsafe extern "C" fn(L: *mut lua_State) -> libc::c_int>;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Reader>
...
>;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Writer>
...
>;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Alloc>
...
>;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Number>
pub type lua_Number = f64;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Integer>
pub type lua_Integer = isize;
/// <https://www.lua.org/manual/5.2/manual.html#lua_Unsigned>
pub type lua_Unsigned = libc::c_uint;
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_newstate>
    pub fn lua_newstate(f: lua_Alloc, ud: *mut libc::c_void) -> *mut lua_State;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_close>
    pub fn lua_close(L: *mut lua_State);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_newthread>
    pub fn lua_newthread(L: *mut lua_State) -> *mut lua_State;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_atpanic>
    pub fn lua_atpanic(L: *mut lua_State, panicf: lua_CFunction) -> lua_CFunction;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_version>
    pub fn lua_version(L: *mut lua_State) -> *const lua_Number;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_absindex>
    pub fn lua_absindex(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_gettop>
    pub fn lua_gettop(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_settop>
    pub fn lua_settop(L: *mut lua_State, idx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushvalue>
    pub fn lua_pushvalue(L: *mut lua_State, idx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_remove>
    pub fn lua_remove(L: *mut lua_State, idx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_insert>
    pub fn lua_insert(L: *mut lua_State, idx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_replace>
    pub fn lua_replace(L: *mut lua_State, idx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_copy>
    pub fn lua_copy(L: *mut lua_State, fromidx: libc::c_int, toidx: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_checkstack>
    pub fn lua_checkstack(L: *mut lua_State, sz: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_xmove>
    pub fn lua_xmove(from: *mut lua_State, to: *mut lua_State, n: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_isnumber>
    pub fn lua_isnumber(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_isstring>
    pub fn lua_isstring(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_iscfunction>
    pub fn lua_iscfunction(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_isuserdata>
    pub fn lua_isuserdata(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_type>
    pub fn lua_type(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_typename>
    pub fn lua_typename(L: *mut lua_State, tp: libc::c_int) -> *const libc::c_char;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_tonumberx>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_tounsignedx>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_toboolean>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushnil>
    pub fn lua_pushnil(L: *mut lua_State);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushnumber>
    pub fn lua_pushnumber(L: *mut lua_State, n: lua_Number);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushinteger>
    pub fn lua_pushinteger(L: *mut lua_State, n: lua_Integer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushunsigned>
    pub fn lua_pushunsigned(L: *mut lua_State, n: lua_Unsigned);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushlstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushstring>
    pub fn lua_pushstring(L: *mut lua_State, s: *const libc::c_char) -> *const libc::c_char;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pushvfstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_getctx>
    pub fn lua_getctx(L: *mut lua_State, ctx: *mut libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_pcallk>
    pub fn lua_pcallk(
        L: *mut lua_State,
        nargs: libc::c_int,
        nresults: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_load>
    pub fn lua_load(
        L: *mut lua_State,
        reader: lua_Reader,
        dt: *mut libc::c_void,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_dump>
    pub fn lua_dump(L: *mut lua_State, writer: lua_Writer, data: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_yieldk>
    pub fn lua_yieldk(
        L: *mut lua_State,
        nresults: libc::c_int,
        ctx: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_resume>
    pub fn lua_resume(L: *mut lua_State, from: *mut lua_State, narg: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_status>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_getlocal>
    pub fn lua_getlocal(
        L: *mut lua_State,
        ar: *const lua_Debug,
        n: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_setlocal>
    pub fn lua_setlocal(
        L: *mut lua_State,
        ar: *const lua_Debug,
        n: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_getupvalue>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_setupvalue>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_upvalueid>
    pub fn lua_upvalueid(L: *mut lua_State, fidx: libc::c_int, n: libc::c_int)
        -> *mut libc::c_void;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_upvaluejoin>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_sethook>
    pub fn lua_sethook(
        L: *mut lua_State,
        func: lua_Hook,
        mask: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_gethook>
    pub fn lua_gethook(L: *mut lua_State) -> lua_Hook;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_gethookmask>
    pub fn lua_gethookmask(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#lua_gethookcount>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_base>
    pub fn luaopen_base(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_coroutine>
    pub fn luaopen_coroutine(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_table>
    pub fn luaopen_table(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_io>
    pub fn luaopen_io(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_os>
    pub fn luaopen_os(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_string>
    pub fn luaopen_string(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_bit32>
    pub fn luaopen_bit32(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_math>
    pub fn luaopen_math(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_debug>
    pub fn luaopen_debug(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaopen_package>
    pub fn luaopen_package(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_openlibs>
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
/// <https://www.lua.org/manual/5.2/manual.html#luaL_Reg>
pub struct luaL_Reg {
    pub name: *const libc::c_char,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checkversion_>
    pub fn luaL_checkversion_(L: *mut lua_State, ver: lua_Number);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_getmetafield>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_callmeta>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_tolstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_argerror>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checklstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_optlstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checkstack>
    pub fn luaL_checkstack(L: *mut lua_State, sz: libc::c_int, msg: *const libc::c_char);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checktype>
    pub fn luaL_checktype(L: *mut lua_State, narg: libc::c_int, t: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checkany>
    pub fn luaL_checkany(L: *mut lua_State, narg: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_newmetatable>
    pub fn luaL_newmetatable(L: *mut lua_State, tname: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_setmetatable>
    pub fn luaL_setmetatable(L: *mut lua_State, tname: *const libc::c_char);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_testudata>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checkudata>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_where>
    pub fn luaL_where(L: *mut lua_State, lvl: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_error>
    pub fn luaL_error(L: *mut lua_State, fmt: *const libc::c_char, ...) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_checkoption>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_fileresult>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_execresult>
    pub fn luaL_execresult(L: *mut lua_State, stat: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_ref>
    pub fn luaL_ref(L: *mut lua_State, t: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_unref>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_loadbufferx>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_loadstring>
    pub fn luaL_loadstring(L: *mut lua_State, s: *const libc::c_char) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_newstate>
    pub fn luaL_newstate() -> *mut lua_State;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_len>
    pub fn luaL_len(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_gsub>
    pub fn luaL_gsub(
        L: *mut lua_State,
        s: *const libc::c_char,
        p: *const libc::c_char,
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_setfuncs>
    pub fn luaL_setfuncs(L: *mut lua_State, l: *const luaL_Reg, nup: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_getsubtable>
...
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_traceback>
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
/// <https://www.lua.org/manual/5.2/manual.html#luaL_Buffer>
...
fn bindgen_test_layout_luaL_Buffer() {
    ...
    assert_eq!(
        ...
        32usize,
        concat!("Offset of field: ", stringify!(luaL_Buffer), "::", stringify!(initb))
    );
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_buffinit>
    pub fn luaL_buffinit(L: *mut lua_State, B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_prepbuffsize>
    pub fn luaL_prepbuffsize(B: *mut luaL_Buffer, sz: usize) -> *mut libc::c_char;
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_addlstring>
    pub fn luaL_addlstring(B: *mut luaL_Buffer, s: *const libc::c_char, l: usize);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_addstring>
    pub fn luaL_addstring(B: *mut luaL_Buffer, s: *const libc::c_char);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_addvalue>
    pub fn luaL_addvalue(B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_pushresult>
    pub fn luaL_pushresult(B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_pushresultsize>
    pub fn luaL_pushresultsize(B: *mut luaL_Buffer, sz: usize);
}
extern "C" {
    /// <https://www.lua.org/manual/5.2/manual.html#luaL_buffinitsize>
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
/// <https://www.lua.org/manual/5.2/manual.html#luaL_Stream>
