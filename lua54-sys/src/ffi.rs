...
pub const LUAI_MAXCSTACK: i32 = 2000;
...
pub const LUA_VERSION_RELEASE: &'static [u8; 2usize] = b"0\0";
pub const LUA_VERSION_NUM: i32 = 504;
pub const LUA_VERSION_RELEASE_NUM: i32 = 50400;
pub const LUA_VERSION: &'static [u8; 8usize] = b"Lua 5.4\0";
pub const LUA_RELEASE: &'static [u8; 10usize] = b"Lua 5.4.0\0";
pub const LUA_COPYRIGHT: &'static [u8; 52usize] =
    b"Lua 5.4.0  Copyright (C) 1994-2020 Lua.org, PUC-Rio\0";
...
/// <https://www.lua.org/manual/5.4/manual.html#lua_State >
pub struct lua_State {
    _unused: [u8; 0],
}
/// <https://www.lua.org/manual/5.4/manual.html#lua_Number >
pub type lua_Number = f64;
/// <https://www.lua.org/manual/5.4/manual.html#lua_Integer >
pub type lua_Integer = libc::c_longlong;
/// <https://www.lua.org/manual/5.4/manual.html#lua_Unsigned >
pub type lua_Unsigned = libc::c_ulonglong;
/// <https://www.lua.org/manual/5.4/manual.html#lua_KContext >
...
/// <https://www.lua.org/manual/5.4/manual.html#lua_KFunction >
...
>;
/// <https://www.lua.org/manual/5.4/manual.html#lua_Writer >
...
>;
/// <https://www.lua.org/manual/5.4/manual.html#lua_WarnFunction >
pub type lua_WarnFunction = ::core::option::Option<
    unsafe extern "C" fn(ud: *mut libc::c_void, msg: *const libc::c_char, tocont: libc::c_int),
>;
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_newstate>
...
extern "C" {
    ...
    pub fn lua_resetthread(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_atpanic>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_xmove>
...
extern "C" {
    ...
    pub fn lua_rawlen(L: *mut lua_State, idx: libc::c_int) -> lua_Unsigned;
}
extern "C" {
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_compare>
    pub fn lua_compare(
        L: *mut lua_State,
        idx1: libc::c_int,
        idx2: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_pushstring>
    pub fn lua_pushstring(L: *mut lua_State, s: *const libc::c_char) -> *const libc::c_char;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_pushvfstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_getfield>
    pub fn lua_getfield(L: *mut lua_State, idx: libc::c_int, k: *const libc::c_char)
        -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_geti>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_rawgetp>
...
extern "C" {
    ...
    pub fn lua_getiuservalue(L: *mut lua_State, idx: libc::c_int, n: libc::c_int) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setfield>
    pub fn lua_setfield(L: *mut lua_State, idx: libc::c_int, k: *const libc::c_char);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_seti>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_rawsetp>
...
extern "C" {
    ...
    pub fn lua_setiuservalue(L: *mut lua_State, idx: libc::c_int, n: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_callk>
    pub fn lua_callk(
        L: *mut lua_State,
        nargs: libc::c_int,
        nresults: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_pcallk>
    pub fn lua_pcallk(
        L: *mut lua_State,
        nargs: libc::c_int,
        nresults: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_dump>
    pub fn lua_dump(
        L: *mut lua_State,
        writer: lua_Writer,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_resume>
    pub fn lua_resume(
        L: *mut lua_State,
        from: *mut lua_State,
        narg: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_isyieldable>
    pub fn lua_isyieldable(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setwarnf>
    pub fn lua_setwarnf(L: *mut lua_State, f: lua_WarnFunction, ud: *mut libc::c_void);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_warning>
    pub fn lua_warning(L: *mut lua_State, msg: *const libc::c_char, tocont: libc::c_int);
}
extern "C" {
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_concat>
    pub fn lua_concat(L: *mut lua_State, n: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_len>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_getlocal>
    pub fn lua_getlocal(
        L: *mut lua_State,
        ar: *const lua_Debug,
        n: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setlocal>
    pub fn lua_setlocal(
        L: *mut lua_State,
        ar: *const lua_Debug,
        n: libc::c_int,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_getupvalue>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setupvalue>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_upvalueid>
    pub fn lua_upvalueid(L: *mut lua_State, fidx: libc::c_int, n: libc::c_int)
        -> *mut libc::c_void;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_upvaluejoin>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_sethook>
    pub fn lua_sethook(L: *mut lua_State, func: lua_Hook, mask: libc::c_int, count: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_gethook>
    pub fn lua_gethook(L: *mut lua_State) -> lua_Hook;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_gethookmask>
    pub fn lua_gethookmask(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_gethookcount>
    pub fn lua_gethookcount(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setcstacklimit>
    pub fn lua_setcstacklimit(L: *mut lua_State, limit: libc::c_uint) -> libc::c_int;
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::core::fmt::Debug for lua_Debug {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write ! (f , "lua_Debug {{ event: {:?}, name: {:?}, namewhat: {:?}, what: {:?}, source: {:?}, srclen: {:?}, currentline: {:?}, linedefined: {:?}, lastlinedefined: {:?}, nups: {:?}, nparams: {:?}, isvararg: {:?}, istailcall: {:?}, ftransfer: {:?}, ntransfer: {:?}, short_src: [...], i_ci: {:?} }}" , self . event , self . name , self . namewhat , self . what , self . source , self . srclen , self . currentline , self . linedefined , self . lastlinedefined , self . nups , self . nparams , self . isvararg , self . istailcall , self . ftransfer , self . ntransfer , self . i_ci)
    }
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_base>
    pub fn luaopen_base(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_coroutine>
    pub fn luaopen_coroutine(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_table>
    pub fn luaopen_table(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_io>
    pub fn luaopen_io(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_os>
    pub fn luaopen_os(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_string>
    pub fn luaopen_string(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_utf8>
    pub fn luaopen_utf8(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_math>
    pub fn luaopen_math(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_debug>
    pub fn luaopen_debug(L: *mut lua_State) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaopen_package>
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
/// <https://www.lua.org/manual/5.4/manual.html#luaL_Reg >
pub struct luaL_Reg {
    pub name: *const libc::c_char,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_checkversion_>
    pub fn luaL_checkversion_(L: *mut lua_State, ver: lua_Number, sz: usize);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_getmetafield>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_callmeta>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_tolstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_argerror>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_typeerror>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_checklstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_optlstring>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_checkudata>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_where>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_checkoption>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_execresult>
    pub fn luaL_execresult(L: *mut lua_State, stat: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_ref>
    pub fn luaL_ref(L: *mut lua_State, t: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_unref>
    pub fn luaL_unref(L: *mut lua_State, t: libc::c_int, ref_: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_loadfilex>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_loadbufferx>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_newstate>
    pub fn luaL_newstate() -> *mut lua_State;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_len>
    pub fn luaL_len(L: *mut lua_State, idx: libc::c_int) -> lua_Integer;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_addgsub>
    pub fn luaL_addgsub(
        b: *mut luaL_Buffer,
        s: *const libc::c_char,
        p: *const libc::c_char,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_gsub>
    pub fn luaL_gsub(
        L: *mut lua_State,
        s: *const libc::c_char,
        p: *const libc::c_char,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_setfuncs>
    pub fn luaL_setfuncs(L: *mut lua_State, l: *const luaL_Reg, nup: libc::c_int);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_getsubtable>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_traceback>
...
#[repr(C)]
#[derive(Copy, Clone)]
/// <https://www.lua.org/manual/5.4/manual.html#luaL_Buffer >
...
impl ::core::fmt::Debug for luaL_Buffer__bindgen_ty_1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write!(f, "luaL_Buffer__bindgen_ty_1 {{ union }}")
    }
}
#[test]
...
impl ::core::fmt::Debug for luaL_Buffer {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write!(
            f,
            "luaL_Buffer {{ b: {:?}, size: {:?}, n: {:?}, L: {:?}, init: {:?} }}",
            self.b, self.size, self.n, self.L, self.init
        )
    }
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_buffinit>
    pub fn luaL_buffinit(L: *mut lua_State, B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_prepbuffsize>
    pub fn luaL_prepbuffsize(B: *mut luaL_Buffer, sz: usize) -> *mut libc::c_char;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_addlstring>
    pub fn luaL_addlstring(B: *mut luaL_Buffer, s: *const libc::c_char, l: usize);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_addstring>
    pub fn luaL_addstring(B: *mut luaL_Buffer, s: *const libc::c_char);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_addvalue>
    pub fn luaL_addvalue(B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_pushresult>
    pub fn luaL_pushresult(B: *mut luaL_Buffer);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_pushresultsize>
    pub fn luaL_pushresultsize(B: *mut luaL_Buffer, sz: usize);
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_buffinitsize>
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
/// <https://www.lua.org/manual/5.4/manual.html#luaL_Stream >
