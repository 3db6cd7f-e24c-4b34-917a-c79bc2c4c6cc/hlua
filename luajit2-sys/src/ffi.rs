...
pub const LUAJIT_VERSION_NUM: i32 = 20100;
...
pub const LUAJIT_MODE_MASK: i32 = 255;
pub const LUAJIT_MODE_OFF: i32 = 0;
pub const LUAJIT_MODE_ON: i32 = 256;
pub const LUAJIT_MODE_FLUSH: i32 = 512;
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_equal>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_lessthan>
    pub fn lua_lessthan(L: *mut lua_State, idx1: libc::c_int, idx2: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_tonumber>
    pub fn lua_tonumber(L: *mut lua_State, idx: libc::c_int) -> lua_Number;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_tointeger>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_objlen>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_getfenv>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setfenv>
    pub fn lua_setfenv(L: *mut lua_State, idx: libc::c_int) -> libc::c_int;
}
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_call>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_cpcall>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_setlevel>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#lua_loadx>
    pub fn lua_loadx(
        L: *mut lua_State,
        reader: lua_Reader,
        dt: *mut libc::c_void,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_openlib>
    pub fn luaL_openlib(
        L: *mut lua_State,
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_register>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_typerror>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_loadfile>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_findtable>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_pushmodule>
...
extern "C" {
    /// <https://www.lua.org/manual/5.4/manual.html#luaL_prepbuffer>
...
pub const LUAJIT_MODE_ENGINE: libc::c_int = 0;
pub const LUAJIT_MODE_DEBUG: libc::c_int = 1;
pub const LUAJIT_MODE_FUNC: libc::c_int = 2;
pub const LUAJIT_MODE_ALLFUNC: libc::c_int = 3;
pub const LUAJIT_MODE_ALLSUBFUNC: libc::c_int = 4;
pub const LUAJIT_MODE_TRACE: libc::c_int = 5;
pub const LUAJIT_MODE_WRAPCFUNC: libc::c_int = 16;
pub const LUAJIT_MODE_MAX: libc::c_int = 17;
