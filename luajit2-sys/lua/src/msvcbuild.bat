...
@rem -- added to allow luajit-sys to build properly
@if not defined DASMFLAGS_OPTS ( SET DASMFLAGS_OPTS=-D JIT -D FFI )

@setlocal
@rem Add more debug flags here, e.g. DEBUGCFLAGS=/DLUA_USE_APICHECK
@set DEBUGCFLAGS=
@rem -- edited to not export a ton of MSVC functions
...
@rem -- edited to allow luajit-sys to build properly
@set DASMFLAGS=-D WIN %DASMFLAGS_OPTS% -D P64
...
@rem -- edited to allow luajit-sys to build properly
@set DASMFLAGS=-D WIN %DASMFLAGS_OPTS%
